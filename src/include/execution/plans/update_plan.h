 ...
 */
class UpdatePlanNode final : public AbstractPlanNode {
 public:
  /**
   ...
   */
  UpdatePlanNode(SchemaRef output, AbstractPlanNodeRef child, const table_oid_t table_oid,
  ...
  [[nodiscard]] auto GetType() const -> PlanType override { return PlanType::Update; }
